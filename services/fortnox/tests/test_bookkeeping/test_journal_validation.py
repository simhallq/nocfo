...
from fortnox.bookkeeping.journal import JournalService, VoucherValidationError
from fortnox.api.models import Account, FinancialYear, LockedPeriod, VoucherRow
