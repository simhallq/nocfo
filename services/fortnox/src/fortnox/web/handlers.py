...
from fortnox.browser.handler import BrowserAPIHandler, register_route
...
from fortnox.browser.tokens import generate_token
...
def handle_auth_start(handler: BrowserAPIHandler) -> None:
    ...
    if not force:
        from fortnox.web.session import has_valid_session
...
def trigger_bankid_flow(op_id: str, pw_worker, sessions_dir: str, is_mobile: bool = False) -> None:
    ...
    from fortnox.browser.operations_state import get_operation_internal
    ...
    def run_auth():
        def auth_work(browser):
            from fortnox.web.auth import bankid_login_with_qr_capture
            from fortnox.web.session import save_session
            ...
            try:
                ...
                if not success:
                    ...
                    import time
                    time.sleep(5)
                    from fortnox.web.auth import _is_logged_in, TENANT_SELECT_URL
...
def handle_auth_status(handler: BrowserAPIHandler) -> None:
    ...
    from fortnox.web.session import is_authenticated
...
def handle_auth_login(handler: BrowserAPIHandler) -> None:
    ...
    from fortnox.web.auth import bankid_login
...
def handle_reconciliation_run(handler: BrowserAPIHandler) -> None:
    ...
    from fortnox.web.operations.reconciliation import run_reconciliation
...
def handle_period_close(handler: BrowserAPIHandler) -> None:
    ...
    from fortnox.web.operations.period_closing import close_period
...
def handle_reports_discover(handler: BrowserAPIHandler) -> None:
    ...
    from fortnox.web.operations.reports import discover_report_api
...
def handle_reports_download(handler: BrowserAPIHandler) -> None:
    ...
    from fortnox.web.operations.reports import download_report
...
def handle_rules_list(handler: BrowserAPIHandler) -> None:
    ...
    from fortnox.web.operations.rules import list_rules
...
def handle_rules_sync(handler: BrowserAPIHandler) -> None:
    ...
    from fortnox.web.operations.rules import sync_rules
...
def handle_receipts_book(handler: BrowserAPIHandler) -> None:
    ...
    from fortnox.api.models import Voucher
